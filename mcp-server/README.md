...
- **Project-wide**: search/replace, find-references, clipboard (copy/cut/paste through the OS clipboard), the scrapbook, editor-tab/navigation control, features/imports/build-configs, and project lifecycle (open/save/reload).
